...
namespace Utility
{
	...
	public:
		...
		virtual void SetFillColor(unsigned long color) = 0;
		virtual void SetLineColor(unsigned long color) = 0;
		virtual void SetLineWidth(float width) = 0;
		virtual void SetFont(const CString& szFontFamilyName, float fontSize) = 0;
		virtual void SetAlignment(StringAlignment align) = 0;
	...
	{
	public:
		CGraphics(unsigned long pRenderTarget, RenderType renderType);
		virtual ~CGraphics();
	...
	public:
		// 生成一个颜色值
		static unsigned long MakeColor(unsigned char a, unsigned char r, unsigned char g, unsigned b)
		{
	...
	private:
		// 底层绘图接口
		LowLevelGraphicsContext* m_context = nullptr;
		// 渲染类型
